...
from .core import BaseNode, NodeStatus
...
class TaskNode(BaseNode):
    ...
    def __init__(self, node_id: str, name: Optional[str] = None, process_func: Optional[Callable[[Any], Any]] = None, **kwargs):
        """初始化任务节点
...
class ControlNode(BaseNode):
    ...
    async def _decide_next(self) -> Optional[str]:
        """决定下一个节点的逻辑 - 子类应该实现"""
        # 默认实现：返回第一个出边
