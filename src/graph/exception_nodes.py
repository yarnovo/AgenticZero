...
class TryCatchNode(ExceptionNode):
    ...
    def __init__(
        ...
        try_func: Optional[Callable[[Any], Any]] = None,
        catch_func: Optional[Callable[[Any, Exception], Any]] = None,
    ...
    async def handle_exception(self, exception: Exception, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理异常"""
...
class RetryNode(ExceptionNode):
    ...
    def __init__(
        ...
        node_id: str,
        name: Optional[str] = None,
        target_func: Optional[Callable[[Any], Any]] = None,
        max_retries: int = 3,
...
class CircuitBreakerNode(ExceptionNode):
    ...
    async def exec(self) -> Any:
        ...
        if self.state == "OPEN" and current_time - self.last_failure_time > self.timeout_seconds:
