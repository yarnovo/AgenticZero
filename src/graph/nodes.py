...
class SimpleNode(BaseNode):
    ...
    def __init__(self, node_id: str, name: Optional[str] = None, action: str = "default", **kwargs):
        """
        初始化简单节点
...
class DataProcessorNode(BaseNode):
    ...
    def __init__(self, node_id: str, name: Optional[str] = None, processor_func=None, **kwargs):
        """
        初始化数据处理节点
...
class ConditionalNode(BaseNode):
    ...
    def __init__(self, node_id: str, name: Optional[str] = None, condition_func=None, **kwargs):
        """
        初始化条件节点
...
class RandomChoiceNode(BaseNode):
    ...
    def __init__(self, node_id: str, name: Optional[str] = None, choices: Optional[Dict[str, float]] = None, **kwargs):
        """
        初始化随机选择节点
...
class LoggingNode(BaseNode):
    ...
    def __init__(self, node_id: str, name: Optional[str] = None, log_message: str = "", **kwargs):
        """
        初始化日志节点
...
class DelayNode(BaseNode):
    ...
    def __init__(self, node_id: str, name: Optional[str] = None, delay_seconds: float = 1.0, **kwargs):
        """
        初始化延迟节点
...
class ErrorNode(BaseNode):
    ...
    def __init__(self, node_id: str, name: Optional[str] = None, error_message: str = "模拟错误", **kwargs):
        """
        初始化错误节点
...
class FunctionNode(BaseNode):
    ...
    def __init__(self, node_id: str, name: Optional[str] = None, 
                 prep_func: Optional[Callable] = None,
